...
class ConceptsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create concept" do
    assert_difference("Concept.count") do
      post concepts_url, params: { concept: { concept: @concept.concept, concept_topic_id: @concept.concept_topic_id } }
    end
  ...
  test "should update concept" do
    patch concept_url(@concept), params: { concept: { concept: @concept.concept, concept_topic_id: @concept.concept_topic_id } }
